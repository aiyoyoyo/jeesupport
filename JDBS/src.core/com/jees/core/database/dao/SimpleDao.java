...
public class SimpleDao extends AbsSupportDao {
	 ...
	 * @return
	 */
	public < T > List< T > selectBy_News( String _dbName , Class< T > _cls , String _table , String _time ,
		...
		return selectBySQL( _dbName , sql , new Object [] {} , _cls );
	}
	...
	public < T > List< T > selectBy_In( String _dbName , Class< T > _cls , String _property , Object[] _param ) {
		return _get_session( _dbName ).createCriteria( _cls ).add( Restrictions.in( _property , _param ) ).list();
	}
}
