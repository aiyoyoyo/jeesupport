...
public class MessageFile{
    ...
    public static void write( Integer _cmd, Long _usr, String _json, boolean _toc ){
        if( check() ){
            _write_( _cmd, _usr, _json, _toc );
        }
    }

    public static void write( Integer _cmd, Long _usr, JSONObject _job, boolean _toc ){
        if( check() ){
    ...
    public static void write( Integer _cmd, Long _usr, Message _msg, boolean _toc ){
        if( check() ){
