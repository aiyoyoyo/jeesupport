...
public class SensitiveWordUtil{
    ...
    public static void main(String[] args) throws IOException {
        ...
        //这是我自己项目中使用
//        ClassPathResource classPathResource = new ClassPathResource("关键词.txt");
//        List<String> list = Files.readLines(classPathResource.getFile(), Charset.forName("gbk"));
        List<String> list = Arrays.asList("A","AB", "ABC");


        //初始化敏感词库
        SensitiveWordUtil.init(new HashSet<String>(list));

        System.out.println("敏感词的数量：" + SensitiveWordUtil.sensitiveWordMap.size());
        String string = "xAxBxCxABxBCxABCx";
